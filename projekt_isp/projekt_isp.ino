...
void setup(){
  ...
  delay(1000);
  serialSIM800.write("AT+CPIN=\"1111\"\r\n");
...
void gsm_sendthttp()
{ 
  //Konfiguracja GPRS i wysylanie na serwer
  ...
  runs1();
  delay(100);
  serialSIM800.println("AT+SAPBR=3,1,USER," + apn_u)
  runs1();
  delay(100);
  serialSIM800.println("AT+SAPBR=3,1,PWD," + apn_p);
  runs1();
  delay(100);
